...
public class MainPage extends javax.swing.JFrame {
    ...
    private void getTracNo(){
        try{
            String sql = "select * from Lap where status = '"+str+"'";
    ...
    public void UpdateData(){
        try{
            String s = T6.getText();
            String ss = T8.getText();
            String sql = "update lap set status='"+str1+"' where lapno ='"+s+"' and trackno = '"+ss+"'";
            pst= conn.prepareStatement(sql);
            pst.executeUpdate();
            pst.close();
    ...
    public void pick_picture(String Use){
        try{
            ...
            if(rs.next()){
                ...
                Image img = image.getScaledInstance(80,70,Image.SCALE_SMOOTH);
    ...
    private void initComponents() {
        ...
        User2.setFont(new java.awt.Font("CenturyRepriseBlackSSi", 1, 14)); // NOI18N
        ...
        MidPage.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 20, 244, 40));
        ...
        jLabel2.setText("\"security Parking and safe handling over the day and night\" ");
        MidPage.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 60, -1, -1));

        Content.setLayout(new java.awt.CardLayout());

        P1.setBackground(new java.awt.Color(51, 51, 51));
        P1.setPreferredSize(new java.awt.Dimension(770, 500));

        Park1.setBackground(new java.awt.Color(0, 153, 153));
        Park1.setText("Park");
        Park1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Park1ActionPerformed(evt);
            }
        });
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 204, 204)), "Park Your Car", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 12), new java.awt.Color(255, 102, 0))); // NOI18N
        ...
        jLabel37.setText("Parking Issue");
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "------Select-------", "Toyota", "Ferrari", "Mustang", "Spacio", "Vitz", "Mark-X", "V8", "V6", "Poshe", "Lambo", "None of the Above", " " }));

        T8.setEditable(false);

        jLabel44.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        jLabel44.setForeground(new java.awt.Color(255, 255, 255));
        jLabel44.setText("Parking Expiry");

        jLabel45.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        jLabel45.setForeground(new java.awt.Color(255, 255, 255));
        jLabel45.setText("Track No.");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel37, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel44, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel39, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel45, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel41, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, P1Layout.createSequentialGroup()
                ...
                .addGroup(P1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(P1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(Park1, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        Park.setBackground(new java.awt.Color(0, 128, 145));
        ...
        B1.setBackground(new java.awt.Color(0, 128, 145));
        B1.setFont(new java.awt.Font("DIN", 0, 14)); // NOI18N
        B1.setForeground(new java.awt.Color(255, 255, 255));
        B1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        B1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/im/Park and Charge_16px.png"))); // NOI18N
        B1.setText("Park");
        ...
        ParkLayout.setVerticalGroup(
            ParkLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(B1, javax.swing.GroupLayout.DEFAULT_SIZE, 27, Short.MAX_VALUE)
        );
        ...
        User.setFont(new java.awt.Font("CenturyRepriseBlackSSi", 1, 14)); // NOI18N
                ...
                .addGroup(ActionsPLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(ActionsPLayout.createSequentialGroup()
                        .addGroup(ActionsPLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(Park, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void BtnsMousecliked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BtnsMousecliked
         if(evt.getSource()== B1){
            P1.setVisible(true);
            P2.setVisible(false);
            P3.setVisible(false);
    ...
    }//GEN-LAST:event_BtnsMousecliked

    private void B1MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_B1MouseEntered
   
            Park.setBackground(new Color(246,89,102));
 
    }//GEN-LAST:event_B1MouseEntered

    private void B1MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_B1MouseExited
        Park.setBackground(new Color(0,128,145));
    }//GEN-LAST:event_B1MouseExited

    private void B1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_B1MousePressed
        Park.setBackground(new Color(43,44,67));
    ...
    private void Park1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Park1ActionPerformed
        try{
            String sql ="insert into Parked (plate,name,gender,position,brand,issue,expiry,lapno,trackno) values (?,?,?,?,?,?,?,?,?)";
            pst = conn.prepareStatement(sql);
            ...
            pst.setString(4, T9.getText());
            pst.setString(5, (String)jComboBox2.getSelectedItem());
            pst.setString(6, ((JTextField)jDateChooser4.getDateEditor().getUiComponent()).getText());
        ...
        catch(Exception e){JOptionPane.showMessageDialog(null,"Error occured while parking"+e.getMessage());}
    }//GEN-LAST:event_Park1ActionPerformed
    public void clear(){
    ...
    public void rel(){
            ...
            pst.setString(6, ((JTextField)jDateChooser1.getDateEditor()).getText());
...
public void clear_all(){
    ...
    private javax.swing.JButton Park1;
